...
function verificarPontosCasa(opcoesSelecionadas, balaoFala) {
    ...
    const casas = {
        "grifinoria": {
            3: "Hummm, difícil, muito difícil...",
            6: "Hummm, acho que estou te entendendo melhor... Aaah sim, entendo, entendo...",
            12: "Humm, coragem... Você tem uma sede de se provar. Onde devo te colocar?",
            20: "Você possui uma coragem inabalável e um coração que anseia por aventuras!",
            25: "Você é verdadeiramente destemido, com certeza seu nome será de destaque na história!"
        },
        "sonserina": {
            3: "Hummm, difícil, muito difícil...",
            6: "Hummm, acho que estou te entendendo melhor... Aaah sim, entendo, entendo...",
            12: "Você possui uma ambição notável. Certo talento também. Onde devo te colocar?",
            20: "Sua astúcia e determinação são dignas de grandes homens que já passaram por aqui.",
            25: "Você tem um potencial tremendo. Ambição e inteligência em abundância! Grandes feitos você terá"
        },
        "corvinal": {
            3: "Hummm, difícil, muito difícil...",
            6: "Hummm, acho que estou te entendendo melhor... Aaah sim, entendo, entendo...",
            12: "Sua inteligência e criatividade são admiráveis. Sonserina...Talvez, talvez. Onde devo te colocar?",
            20: "Vejo que você valoriza muito sua inteligência e conhecimento.",
            25: "Você possui sabedoria e discernimento notáveis como muitos grandes sábios que já passaram por aqui"
        },
        "lufalufa": {
            3: "Hummm, difícil, muito difícil...",
            6: "Hummm, acho que estou te entendendo melhor... Aaah sim, entendo, entendo...",
            12: "Você possui um grande coração e paciência. Grandes virtudes. Onde devo te colocar?",
            20: "Sua lealdade e gentileza são características fundamentais de quem você é.",
            25: "Sua gentileza e compaixão são incomparáveis! Seu nome brilhará entre os grandes, eu vejo."
        }
    };
